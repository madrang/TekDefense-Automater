...
class Parser:
    ...
    def hasCEFOutFile(self):
        ...
        Return value(s):
            Boolean
        """
        return True if self.args.cef else False
    ...
    def CEFOutFile(self):
        ...
        """
        return self.args.cef if self.hasCEFOutFile() else None
    ...
    def hasHTMLOutFile(self):
        ...
        Return value(s):
            Boolean
        """
        return True if self.args.web else False
    ...
    def HTMLOutFile(self):
        ...
        """
        return self.args.web if self.hasHTMLOutFile() else None
    ...
    def hasTextOutFile(self):
        ...
        Return value(s):
            Boolean
        """
        return True if self.args.output else False
    ...
    def TextOutFile(self):
        ...
        """
        return self.args.output if self.hasTextOutFile() else None
    ...
    def hasCSVOutSet(self):
        ...
        Return value(s):
            Boolean
        """
        return True if self.args.csv else False
    ...
    def CSVOutFile(self):
        ...
        """
        return self.args.csv if self.hasCSVOutSet() else None
    ...
    def hasProxy(self):
        ...
        Return value(s):
            Boolean
        """
        return True if self.args.proxy else False
    ...
    def Proxy(self):
        ...
        """
        return self.args.proxy if self.hasProxy() else None
    ...
    def hasTarget(self):
        ...
        Return value(s):
            Boolean
        """
        return False if self.args.target is None else True
    ...
    def Target(self):
        ...
        """
        return self.args.target if self.hasTarget() else None
...
class VersionChecker:
    ...
    def getModifiedFileInfo(cls, prefix, gitlocation, filelist):
        ...
        try:
            ...
            return f"There was an error while checking the version of the Automater files." \
                   " Please see {gitlocation} to determine if there is an issue with your local files"
